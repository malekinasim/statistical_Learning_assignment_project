#feature_engineering/politic/PoliticDataLoader.py
from utils.DataReader import DataReader
from utils.feature_engineering.politic.PartyFeatures import PoliticPartyFeatures
import pandas as pd

class PoliticDataReader(DataReader):
    ...
    def load_political_data_main(file_path):
        ...
        # Expand years
        data = PoliticDataReader.__expand_rows(data)
        ...
        df = DataReader.to_dataFrame(political_party_features_list)
